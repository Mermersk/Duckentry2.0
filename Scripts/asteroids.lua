...
function asteroid:initialize(image)
  ...
  self.aster = {}
  for i = 1, 4 do
    table.insert(self.aster, {ast_x = (1550 + love.math.random(5, 100)) , ast_y = love.math.random(5, 320), ast_speed = love.math.random(25, 170), ast_snu = love.math.random(1, 20)/10, ast_start = 0})
  end
...
function asteroid:update(dt)
  ...
  for lykill, gildi in pairs(self.aster) do      --Tegund 1 af asteroids
...
function asteroid:draw()
  for lykill, gildi in pairs(self.aster) do
    ...
    love.graphics.circle("fill", gildi.ast_x, gildi.ast_y, self.asteroid_image:getHeight()*0.025, 16)  --Nákvæmlega sömu tölur og í collision formúlunni, hring með dama radius þá get ég séð árekstarsvæðin!
